actor {
    ...
    // 2. Write a function volume that takes a natural number n and returns the volumue of a cube with side length n.
    ...
    public func hours_to_minutes(n : Int) : async Int {
        return n * 60;
    };
